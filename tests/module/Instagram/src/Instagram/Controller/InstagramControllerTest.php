...
use Instagram\Controller\InstagramController,
    Zend\Http\Request,
    Zend\Http\Response,
    Zend\Mvc\MvcEvent,
...
class InstagramControllerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetKeyAction() {
        // $token ="1953016610.8c7478e.550be686ec1f486099ccab8aba370b16";
        $latitude = 10.884327;
        $longtitude = 106.652044;
        $distance = 1000;
        $result = $this->searchMedia($latitude, $longtitude, $distance, null, null);
        print_r($result);
        $this->assertTrue(isset($result));
